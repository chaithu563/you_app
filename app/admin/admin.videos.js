System.register(['@angular/core', '@angular/router-deprecated', '../common/carousel.component', '@angular/http', '../httpclient', 'rxjs/Rx', '../interfaces/videoinfo'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_deprecated_1, carousel_component_1, http_1, httpclient_1, videoinfo_1;
    var AdminVideos;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            AdminVideos = (function () {
                ...
                AdminVideos = __decorate([
                    ...
                    __metadata('design:paramtypes', [httpclient_1.HttpClient, router_deprecated_1.Router])
                ], AdminVideos);
                return AdminVideos;
            }());
